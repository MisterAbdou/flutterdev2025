...
class InscriptionMedecin extends StatefulWidget {
  const InscriptionMedecin({super.key});

  @override
  State<InscriptionMedecin> createState() => _InscriptionMedecinState();
}
...
class _InscriptionMedecinState extends State<InscriptionMedecin> {
      ...
      onPressed: _isLoading
          ...
          : () async {
              if (valeur == 1) {
                ...
                try {
                  await _controller.inscrireMedecin(photo: _photoChoisie);
  ...
  void _afficherErreur(String message) {
    String msg = message;
    if (message.contains('network-request-failed')) msg = "Erreur réseau.";
    if (message.contains('permission-denied'))
      msg = "Accès refusé. Vérifiez les règles Firebase.";
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 15),
              buildInput(
                "Votre numero ordre des medecins",
                Icons.numbers_outlined,
                _controller.numOrdreController,
              ),
              const Text(
                "Ce numero est essentiel pour pouvoir s'exercer",
                style: TextStyle(
                  color: Color.fromARGB(255, 65, 137, 66),
                  fontWeight: FontWeight.w600,
                  fontSize: 14,
